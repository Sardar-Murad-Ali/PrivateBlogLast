...
let authSchema=new mongoose.Schema({
    ...
    followings :[{ type: mongoose.Types.ObjectId, ref: 'BlogAppUsers' }],
    followers : [{ type: mongoose.Types.ObjectId, ref: 'BlogAppUsers' }],
})
...
export default mongoose.model("BlogAppUsers",authSchema)
